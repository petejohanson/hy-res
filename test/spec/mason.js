...
var MasonExtension = require('../../src/mason');
...
describe('MasonExtension', function () {
  var addlMediaType = 'application/vnd.co.format+json';
  var extension;


  beforeEach(function() {
    extension = new MasonExtension([addlMediaType]);
  });

  describe('extension applicability', function() {
    it('should apply to application/vnd.mason+json content type', function() {
      expect(extension.applies({}, { 'content-type': 'application/vnd.mason+json' }, 200)).to.be.true;
    });

    it('should apply to application/vnd.mason+json content type with params', function() {
      expect(extension.applies({}, { 'content-type': 'application/vnd.mason+json; charset=utf-8' }, 200)).to.be.true;
    });
  ...
  describe('links parser', function() {
    it('should return the links', function() {
      var links = extension.linkParser({'@controls': { self: { href: '/orders/123' } } }, {}, {}, {});
